 ...
 */
package edu.nwmissouri.springbream.marceline;
...
public class PageRankMarci {
  ...
  public static void main(String[] args) {
    ...
    for (File file : dataDir.listFiles()) {
      ...
      PCollection<KV<String, String>> previousData = combinedData.apply(Flatten.pCollections());
    ...
    combinedData.apply(Flatten.pCollections())
